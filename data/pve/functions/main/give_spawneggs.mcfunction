...
give @s minecraft:bat_spawn_egg{display:{Name:'{"text":"Small"}'},EntityTag:{id:"minecraft:armor_stand",CustomNameVisible:1b,Tags:["Small","Enemy","Important"],CustomName:'{"text":"Small"}'}} 1
